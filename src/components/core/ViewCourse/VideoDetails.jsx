...
const VideoDetails = () => {
  ...
  return (
    <div  className="relative " >
        ...
        : (
            <Player
                ...
                src={videoData?.videoUrl}
                 ...
                 >
                <span className="absolute translate-x-[550px] translate-y-[-400px] text-5xl">  <AiFillPlayCircle /></span>
                        ...
                        <div className="flex justify-end gap-3 mt-3 ">
                                ...
                                !completedLectures.includes(subSectionId) && (
                                    <IconBtn 
                                        ...
                                        text={!loading ? "Mark As Completed" : "Loading..."}
                                         customClasses="bg-gray-700 text-white hover:bg-gray-800"
                                    />
                                )
                            }
                            ...
                            <div>
                                ...
                                {!isLastVideo() && (
                                    ...
                                    className='blackButton bg-richblack-500 text-white'>
                                        Next
                                    </button>
                                )}
                            </div>
      ...
      <h1 className="text-richblack-100 font-semibold  mt-3">
        {videoData?.title}
      </h1>
